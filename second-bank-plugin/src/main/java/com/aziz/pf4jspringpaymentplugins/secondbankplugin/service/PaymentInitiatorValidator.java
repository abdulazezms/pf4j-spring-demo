package com.aziz.pf4jspringpaymentplugins.secondbankplugin.service;
...
public class PaymentInitiatorValidator {
    ...
    static {
        validAccountNumbers = new HashSet<>(Set.of("4", "5", "6"));
        validCurrencies = new HashSet<>(Set.of(Currency.EUR, Currency.USD));
    }
